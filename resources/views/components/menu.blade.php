<nav class="navbar navbar-expand-lg navbar-light position-fixed w-100">
    <div class="container-fluid">
        <a class="navbar-brand align-middle d-flex logo-container">
                <button onclick="window.location.href = '/'" formaction='index.php' class="btn-inicio" title="Inicio"></button>
            ...
            <ul class="navbar-nav d-flex justify-content-end w-100">
                ...
                <li class="nav-item">
                    <div class="LogInAccount d-flex justify-content-end" id="LogInSession">
                        ...
                        @if (Auth::user())
                            <button onclick='location.href="php/functions/closeSesion.php";' formaction='index.php' class="btn-logout me-2" title="Cerrar sesión"></button>
                        @endif
                    </div>
                </li>
            </ul>
