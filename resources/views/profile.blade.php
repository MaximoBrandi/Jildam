...
@section('body')
    <center>
        <section id="seccionOpciones">
            <nav id="navPerfil">
                <img src="{{$data['pfp']}}" id="photoPerfil" alt="Perfil">
                <div id="opciones">
            ...
            <div id="contenido">
                <section id="Personalizar">
                    <div id="PerfilCambiar">
                        <img id="photoPerfilCambiar" src="{{$data['pfp']}}">
                    ...
                    <form id="formContenido" class="text-center" action="php/functions/perfil.php" method="post">
                        <div class="input-group flex-column flex-nowrap w-75 mx-auto">
                            <label>Usuario</label>
                            <input type="text" class="form-control" value="{{Auth::user->username}}" name="User" aria-describedby="addon-wrapping" autocomplete="off">
                        </div>
                        <div class="input-group flex-column flex-nowrap w-75 mx-auto">
                            <label class="espacio">Nombre</label>
                            <input type="text" class="form-control" value="{{$data['name']}}" name="Name" aria-describedby="addon-wrapping" autocomplete="off">
                        </div>
                        <div class="input-group flex-column flex-nowrap w-75 mx-auto">
                            <label class="espacio">Apellido</label>
                            <input type="text" class="form-control" value="{{$data['surname']}}" name="surName" aria-describedby="addon-wrapping" autocomplete="off">
                        </div>
                        <div class="mb-3 espacio w-75 mx-auto">
                            <label>Biografía</label>
                            <textarea class="form-control" name="Bio" id="exampleFormControlTextarea1" rows="3">{{$data['biography']}}</textarea>
                        </div>
